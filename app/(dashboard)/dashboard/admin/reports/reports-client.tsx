...
interface Props { semesters: Semester[]; prodiList: Prodi[]; activeSemesterId?: string }
...
export function AdminReportsClient({ semesters, prodiList, activeSemesterId }: Props) {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up" id="main-content">
      <h1 className="text-2xl font-bold tracking-tight">Laporan e-Kendali Dosen &mdash; Admin</h1>
      ...
      <div className="flex flex-wrap items-end gap-4">
        ...
        <Button onClick={fetchData} disabled={loading || !semesterId} aria-label="Tampilkan laporan">
        ...
        {data && (
          <>
            ...
            <Button variant="outline" asChild aria-label="Rekap Hadir">
            ...
            <Button variant="outline" asChild aria-label="Rekap Daring">
          ...
          <Card>
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>Dosen</TableHead><TableHead>Prodi</TableHead><TableHead>MK</TableHead><TableHead>SKS</TableHead><TableHead>Progress</TableHead><TableHead>Daring/Luring</TableHead><TableHead>Hadir%</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {data.dosen.map((d) => (
