  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) handleClose() }}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Import MK dari Excel</DialogTitle>
          <DialogDescription>Upload file Excel dengan data mata kuliah</DialogDescription>
        </DialogHeader>
        ...
        {step === "upload" && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Pastikan kolom: Nama, Kode, SKS, TotalPertemuan, ProdiCode, SemesterName
            </p>
        ...
        {step === "result" && result && (
          <div className="space-y-4">
            <div className="rounded-lg border p-4 space-y-2">
              <p className="text-sm">Berhasil: <strong>{result.created}</strong> MK</p>
              <p className="text-sm">Gagal: <strong>{result.failed}</strong> MK</p>
            </div>
